...
export const useInventoryStore = defineStore('inventory', {
  ...
  actions: {
    ...
    async fetchTransfers(params: Record<string, string> = {}) {
      this.transfers = await inventoryApi.transfers({ warehouseId: this.currentWarehouseId, ...params }) as unknown as TransferOrder[];
    },
  },
});
